package com.luck.picture.library.loader
...
const val NOT_GIF = "(${MediaStore.MediaColumns.MIME_TYPE}!='image/gif')"
const val NOT_WEBP = "(${MediaStore.MediaColumns.MIME_TYPE}!='image/webp')"
const val NOT_BMP = "(${MediaStore.MediaColumns.MIME_TYPE}!='image/bmp')"
