package com.luck.picture.library.base
...
import com.luck.picture.library.SelectorPreviewFragment
...
import com.luck.picture.library.registry.SoundCaptureComponent
import com.luck.picture.library.registry.VideoCaptureComponent
import com.luck.picture.library.service.ForegroundService
import com.luck.picture.library.utils.FileUtils
import com.luck.picture.library.utils.MediaStoreUtils
        ...
        menuFragment.setOnMenuItemClickListener { position ->
            when (menuItems[position]) {
                getString(sR.string.picture_shot_item) -> {
                    ...
                    if (onCheckSelectValidity(media, false) == SelectedState.SUCCESS) {
