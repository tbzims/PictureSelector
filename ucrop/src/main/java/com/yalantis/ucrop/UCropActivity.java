...
public class UCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        setTheme(TmmThemeContext.INSTANCE.getThemeResId());
...
//        setStatusBarColor(mStatusBarColor);
        ...
        ClickUtils.applySingleDebouncing(tvComplete, new View.OnClickListener() {
            @Override
        ...
        ViewCompat.setOnApplyWindowInsetsListener(toolbar, new OnApplyWindowInsetsListener() {
            ...
            public WindowInsetsCompat onApplyWindowInsets(@NonNull View v, @NonNull WindowInsetsCompat insets) {
                ...
                ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) tvComplete.getLayoutParams();
                layoutParams.bottomMargin = navigationBars.bottom + UCropActivity.this.getResources().getDimensionPixelSize(com.tmmtmm.im.style.R.dimen.dp_8);
                return insets;
            }
        });
    }
